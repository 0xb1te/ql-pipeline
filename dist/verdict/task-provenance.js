 ...
 */
// @signal taskSuffixOf
export function taskSuffixOf(headRef) {
...
function suffixOfTaskId(taskId) {
...
export function decideTaskProvenance(input) {
    ...
    if (suffix === null) {
        return {
            kind: 'no-task',
            reason: `branch ${headRef} does not end in a six-character task id, so it was not created by ql-sprint ` +
...
export function taskProvenanceFinding(provenance) {
...
//# sourceMappingURL=task-provenance.js.map