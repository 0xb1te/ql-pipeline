...
| TASK049-27 | Live: the govern run on this pull request logs the not-required line | 'preview environment: not required — no apps/*frontend* or apps/*backend* directory' |  |  | Gate 3 - read the checks / ql-pipeline log after the push |  |
