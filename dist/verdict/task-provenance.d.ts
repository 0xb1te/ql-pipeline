 ...
 */
export declare function taskSuffixOf(headRef: string): string | null;
/**
 ...
 */
export declare function decideTaskProvenance(input: TaskProvenanceInput): TaskProvenance;
/**
 ...
 */
export declare function taskProvenanceFinding(provenance: TaskProvenance): Finding | null;
