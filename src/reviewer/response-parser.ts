...
function validateReviewVerdictShape(value: unknown): ParseResult<ReviewVerdict> {
  if (!isRecord(value)) {
...
function validateFindingShape(value: unknown, index: number): ParseResult<Finding> {
  if (!isRecord(value)) {
