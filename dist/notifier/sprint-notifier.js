...
export function sprintNotifierCredentialsFromEnv(env = process.env) {
...
export function createSprintNotifier(credentials, env = process.env) {
    return async (notice) => {
...
//# sourceMappingURL=sprint-notifier.js.map